...
PRIVATE_MEMBER_OFFSET_ACCESSOR(CCameraComponent, projection) \
DECLARE_CLASS(CCameraComponent, CSceneComponent, Engine)


#undef FILE_ID
#define FILE_ID Engine_CameraComponent_h
