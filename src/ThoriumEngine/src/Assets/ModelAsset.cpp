...
void CModelAsset::OnInit(IBaseFStream* stream)
{
...
void CModelAsset::OnSave(IBaseFStream* stream)
{
...
void CModelAsset::OnLoad(IBaseFStream* stream, uint8 lodLevel)
{
	if (!bRegistered)
		return;
...
uint8 CModelAsset::GetFileVersion() const
{
	return THMDL_VERSION;
}
