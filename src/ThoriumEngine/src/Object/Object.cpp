...
void CObject::Serialize(FMemStream& out, const FSerializeSettings& settings)
{
	...
	while (t != nullptr)
	{
		TUniquePtr<FStructPropertyHandler> handler = new FStructPropertyHandler(this, t);
		handler->SetSerializeSettings(settings);
		handler->SetDefaultObject(classObj->GetDefaultObject());
...
//	case EVT_CLASS:
//	{
//		const TObjectPtr<CObject> ptr = *(CObject**)((SizeType)object + offset);
//		if (ptr.IsValid())
//			data << &ptr->id;
//		else
//			data << &zero;
...
//	case EVT_ARRAY:
//	{
//		// TODO: reimplement array serialization.
...
//	case EVT_OBJECT_PTR:
//	{
//		const TObjectPtr<CObject>& ptr = *(TObjectPtr<CObject>*)((SizeType)object + offset);
//
